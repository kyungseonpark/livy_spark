...
# 1. Custom environment variables defined below after AIZEN defaults
# 2. Constants defined in this file (environment variables with no default), i.e. AIZEN_ROOT_DIR
...
export AIZEN_ROOT_DIR="/opt/aizen"
export AIZEN_VOLUME_DIR="/aizen"

# Logging configuration
export MODULE="${MODULE:-spark}"
export AIZEN_DEBUG="${AIZEN_DEBUG:-false}"
...
# Paths
export SPARK_BASE_DIR="${AIZEN_ROOT_DIR}/spark"
